...
/**/
	.globl ReadInt
	.ent ReadInt
ReadInt:			//cac lenh nay de nhay de label trong hop ngu
	addiu $2,$0,SC_ReadInt  // cho ma SC_ReadInt la 11 vao thanh ghi so 2
	syscall			//goi he dieu hanh xu li syscall ReadInt
	j $31
	.end ReadInt

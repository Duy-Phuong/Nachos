...
#define SC_Fork		9
#define SC_Yield	10
#define SC_ReadInt 	11 //dinh nghia ma cua syscall
...
#define	SC_OpenFileID	18			/* open file  */
#define	SC_ReadFile	19			/* read file  */
#define	SC_SeekFile	20			/* seek file  */
#define SC_CloseFile 	21			/*close file*/
#define	SC_WriteFile	22			/* write file  */
#define SC_Sub		43
...
int ReadInt(); //khai bao cac ten ham cua syscall
